...
player.greet()
print(f"Здоровье: {player.health}, Сила: {player.strength}")
...
print(f"\n✅ {player.name}: здоровье восстановлено до {player.health}")
print(f"✅ {enemy.name}: здоровье восстановлено до {enemy.health}")